 ...
 */
add_filter( 'dynamic_sidebar_params', 'wayako_widget_classes' );

if ( ! function_exists( 'wayako_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function wayako_widget_classes( $params ) {
...
} // End of if function_exists( 'wayako_widget_classes' ).

add_action( 'widgets_init', 'wayako_widgets_init' );

if ( ! function_exists( 'wayako_widgets_init' ) ) {
	/**
	...
	function wayako_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'wayako' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'wayako' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'wayako' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'wayako' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
