...
add_filter( 'mce_buttons_2', 'wayako_tiny_mce_style_formats' );

if ( ! function_exists( 'wayako_tiny_mce_style_formats' ) ) {
	/**
	 ...
	 * @return array
	 */
	function wayako_tiny_mce_style_formats( $buttons ) {
		array_unshift( $buttons, 'styleselect' );
		return $buttons;
	}
}

add_filter( 'tiny_mce_before_init', 'wayako_tiny_mce_before_init' );

if ( ! function_exists( 'wayako_tiny_mce_before_init' ) ) {
	/**
	 ...
	 * @return array
	 */
	function wayako_tiny_mce_before_init( $settings ) {
