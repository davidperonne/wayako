...
if ( ! function_exists( 'wayako_scripts' ) ) :
	...
	function wayako_scripts() {
		...
		wp_enqueue_style( 'splide-styles', get_template_directory_uri() . '/vendor/splide/css/splide.min.css', array(), $theme_version );
	...
	//	wp_enqueue_script( 'flexslider-scripts', get_template_directory_uri() . '/vendor/flexslider/js/jquery.flexslider-min.js', array(), $theme_version, true );
		...
		wp_enqueue_script( 'splide-scripts', get_template_directory_uri() . '/vendor/splide/js/splide.min.js', array(), $theme_version, true );
